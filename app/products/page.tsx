...
export default function ProductsPage() {
  ...
  function buildCarousel(startTitle?: string) {
    ...
    [
      { 
        t: "Pinch Pleat", 
        img: "https://m.media-amazon.com/images/I/81AzAgrBjXL.jpg" 
      },
      { 
        t: "Ripplefold", 
        img: "https://m.media-amazon.com/images/I/71Kt31YU8-L._AC_UF894,1000_QL80_.jpg" 
      },
      { 
        t: "Grommet / Inverted", 
        img: "https://m.media-amazon.com/images/I/91FfebWAuVL.jpg" 
      },
      { 
        t: "Fullness Sizes (reference)", 
        img: "/assets/ripplefold-fullness-chart.jpg" 
      },
      // Fullness sizes reference image should be part of the ripplefold section. When user scrolls through images, the fullness chart will appear there.
    ].forEach(i => items.push(i));
    // Roller Shades (with previews)
    [
      { 
        t: "Inside Mount", 
        img: "/assets/Specialty Items/Roller Shades/Roller Shade .png" 
      },
      { 
        t: "Outside Mount", 
        img: "/assets/Specialty Items/Roller Shades/Healthcare Roller Shades.png" 
      },
      { 
        t: "Dual Shades", 
        img: "/assets/Specialty Items/Roller Shades/Dual Roller Shade.png" 
      },
      { 
        t: "Blackout Shades", 
        img: "/assets/Specialty Items/Roller Shades/Blackout Roller Shades.png" 
      },
      { 
        t: "Cassette Options", 
        img: "https://m.media-amazon.com/images/I/71fzy67qYxL.jpg" 
      },
      { 
        t: "Bottom Rails", 
        img: "https://m.media-amazon.com/images/I/71E9XW1eNoL._UF894,1000_QL80_.jpg" 
      },
      { 
        t: "Side Channels", 
        img: "https://m.media-amazon.com/images/I/51KL+EDKyhL.jpg" 
      },
    ].forEach(i => items.push(i));
    // Roman (with previews)
    [
      { 
        t: "Flat", 
        img: "/assets/Specialty Items/Roman Shades/Cabot Citrus Farms Resort FL - GR.png" 
      },
      { 
        t: "Relaxed", 
        img: "/assets/Specialty Items/Roman Shades/Relaxed Style Roman Shade.png" 
      },
      { 
        t: "Batten Front/Back", 
        img: "https://blindsdesigns.com/wp-content/uploads/2021/06/2013_DES_UG_Organica_Living-Room.jpeg" 
      }
    ].forEach(i => items.push(i));
    // Valance
    [
      { 
        t: "Laminated Flat Wood Valance", 
        img: "/assets/Specialty Items/Valance/Laminated Flat Wood Valance.png" 
      },
      { 
        t: "Laminated Flat Wood Valance (Alt)", 
        img: "/assets/Specialty Items/Valance/Laminated Flat Wood Valance 2.png" 
      },
    ].forEach(i => items.push(i));
    ...
    [
      { 
        t: "Faux / Wood Blinds", 
        img: "/assets/Specialty Items/Faux Wood Blinds/Faux Wood Blinds.jpg" 
      },
      { 
        t: "Aluminum Venetian Blinds", 
        img: "/assets/Specialty Items/Aluminum Venetian Blinds.png" 
      },
      { 
        t: "Vertical Blinds", 
        img: "/assets/Specialty Items/Vertical Blinds/Vertical Blinds.jpg" 
      },
      { 
        t: "Louvers (Plantation Shutters)", 
        img: "/assets/Specialty Items/Louvers - Plantation Style Shutters/Louver Shutters.png" 
      },
    ].forEach(i => items.push(i));
    ...
    [
      { 
        t: "Ceiling Mount", 
        img: "https://m.media-amazon.com/images/I/61RTo2eLM-L.jpg" 
      },
      { 
        t: "Wall Mount", 
        img: "https://m.media-amazon.com/images/I/61fgIvqeicL._AC_UF1000,1000_QL80_.jpg" 
      },
      { 
        t: "Decorative Hardware", 
        img: "https://www.curtarra.com/cdn/shop/files/hardware-2.jpg?v=6399803644631637833" 
      },
      { 
        t: "H‑Rails (Blk/Brnz/Gold)", 
        img: "https://waclighting.com/storage/waclighting-images/top_prod_image/HT4-BK_IMRO_2.jpg" 
      },
      { 
        t: "Motorized", 
        img: "https://m.media-amazon.com/images/I/71c3JIym3kL.jpg" 
      },
      { 
        t: "Cord Operated", 
        img: "https://www.forestgroup.com/user_files/images/block_thumbnail/CKS_klein.png" 
      },
      { 
        t: "Batons", 
        img: "https://m.media-amazon.com/images/I/81XKoiq2pcL._UF894,1000_QL80_.jpg" 
      },
    ].forEach(i => items.push(i));
      ...
      <Section title="Roman Shades" intro="Tailored styles and fabrications.">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            { 
              t: "Hobbled", 
              img: "/assets/Specialty Items/Roman Shades/Hobbled Roman Shade.png" 
            },
            { 
              t: "Relaxed", 
              img: "/assets/Specialty Items/Roman Shades/Relaxed Style Roman Shade.png" 
